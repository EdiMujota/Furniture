    ...
    <section className="bg-white pt-10">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 text-center">
        <h1 className="text-3xl font-bold text-cyan-700 mb-8 text-center">
                    <span className='border-b-3 border-dashed rounded-b-2xl pb-2 border-gray-300'>Our Features</span>
                </h1>
        <p className="text-gray-600 max-w-2xl mx-auto mb-12">
          Discover why Mobileria Vali stands out in the market with features designed 
