  ...
  return (
    <footer className="bg-base-200 text-gray-700 mt-10">
      <div className="max-w-7xl mx-auto px-4 md:px-10 py-10 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          <h2 className="text-2xl font-bold text-cyan-700 font-work">
            Mobileria<span className="text-gray-900">Vali</span>
          </h2>
        ...
        <div>
          ...
          <p className="text-sm">Ferizaj, Kosovo</p>
          <p className="text-sm">Email: support@mobileriavali.com</p>
          <p className="text-sm">Phone: +383 43 726 083</p>
      ...
      <div className="border-t border-gray-300 py-4 text-center text-sm text-gray-600">
        © {new Date().getFullYear()} Mobileria Vali. All rights reserved.
        <p>Developed By Eduard Mujota</p>
      </div>
    </footer>
  );
};
